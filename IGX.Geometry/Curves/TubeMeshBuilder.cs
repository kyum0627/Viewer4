...
//        {
//            if (curve.Vertices == null || curve.Vertices.Count < 2)
...
//            uint pointCount = (uint)curve.Vertices.Count;
//            Vector3 up = Vector3.UnitZ;

//            Vector3 prevNormal = Vector3.Cross(up, (curve.Vertices[1] - curve.Vertices[0]).Normalized());
...
//                Vector3 tangent;
//                if (i == 0)
//                    tangent = (curve.Vertices[1] - curve.Vertices[0]).Normalized();
//                else if (i == pointCount - 1)
//                    tangent = (curve.Vertices[^1] - curve.Vertices[^2]).Normalized();
//                else
//                    tangent = (curve.Vertices[i + 1] - curve.Vertices[i - 1]).Normalized();
...
//                    vertices.Add(curve.Vertices[i] + offset);
...
//                vertices.Add(curve.Vertices[0]);
//                normals.Add(-(curve.Vertices[1] - curve.Vertices[0]).Normalized());
//                for (uint j = 0; j < circleSegments; j++)
//                {
//                    uint next = (j + 1) % circleSegments;
...
//                vertices.Add(curve.Vertices[^1]);
//                normals.Add((curve.Vertices[^1] - curve.Vertices[^2]).Normalized());
