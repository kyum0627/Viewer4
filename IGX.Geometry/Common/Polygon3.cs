...
namespace IGX.Geometry.Common
{
    ...
    public class Polygon3 : IEnumerable<Vector3>
    {
        ...
        {
            get { return plane.distance; }
            set { plane.distance = value; }
        }
        ...
        public Polygon3(Polygon3 copy, bool reverse = false)
        {
            ...
            //plane.Distance = plane.norID.Dot(ControlPoints[0]);
        }
        ...
        //            TotalCentroid.X = invd * (plane.Distance - plane.norID.Y * TotalCentroid.Y - plane.norID.Z * TotalCentroid.Z);
        //            break;
        //        case 1:
        //            //signedArea *= invd;// norID.y;
        //            TotalCentroid.Z = poly.TotalCentroid.X;
        //            TotalCentroid.X = poly.TotalCentroid.Y;
        //            TotalCentroid.Y = invd * (plane.Distance - plane.norID.Z * TotalCentroid.Z - plane.norID.X * TotalCentroid.X);
        //            break;
        //        case 2:
        //            //signedArea *= invd;// norID.z;
        //            TotalCentroid.X = poly.TotalCentroid.X;
        //            TotalCentroid.Y = poly.TotalCentroid.Y;
        //            TotalCentroid.Z = invd * (plane.Distance - plane.norID.X * TotalCentroid.X - plane.norID.Y * TotalCentroid.Y);
        //            break;
        //    }
        ...
        public float DistanceTo(Vector3 p, float tolerance = MathUtil.Epsilon)
        {
            ...
            float d = plane.GetDistanceToPoint(p);
