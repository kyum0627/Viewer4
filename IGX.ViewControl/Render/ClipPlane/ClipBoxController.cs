...
namespace IGX.ViewControl.Render.ClipPlane
{
    public class ClipBoxController
    {
        ...
        /// </summary>
        public void HandleInput(Point mousePosition, bool isLeftButtonDown)
        {
            if (!IsEnabled) return;

            Ray3f mouseRay = CalculateRay(mousePosition);
        ...
        private Ray3f CalculateRay(Point mousePosition)
        {
