...
namespace IGX.Geometry.Common
{
    ...
    public struct Plane3f : IComparable<Plane3f>, IEquatable<Plane3f>
    {
        ...
        public float distance; // 좌표 원점에서 평면까지 거리
        ...
        public readonly Vector3 AbsNormal
        {
            get
            {
                return distance > 0 ? normal : -normal;
            }
        }
        ...
        /// 평면의 원점
        /// </summary>
        public readonly Vector3 V0 => normal * distance;
        ...
        {
            return new float[] { normal.X, normal.Y, normal.Z, distance };
        }

        /// <summary>
        /// 원점에서 norID 방향으로 거리 Distance 떨어진 평면
        /// </summary>
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        public readonly float GetDistanceToPoint(Vector3 p)
        {
        ...
        public readonly Vector3 Project(Vector3 p)
        {
            ...
            float distance = Vector3.Dot(normal, p) + this.distance;
        ...
        {
            return a.distance == b.distance && a.normal == b.normal;
        }
        ...
        {
            return normal != other.normal ? normal.CompareTo(other.normal) : distance < other.distance ? -1 : distance == other.distance ? 0 : 1;
        }
        ...
        //{
        //    float dist = this.norID.Dot(B.V0id) - this.Distance;
