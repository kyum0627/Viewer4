...
{
    public class DistanceRay3Seg3
    {
        Ray3f ray;
        Segment3f segment;

        public DistanceRay3Seg3(Ray3f r, Segment3f s)
        {
            ray = r;
            segment = s;
        }
        ...
        public Result3f Compute()
        {
            ...
            Vector3 diff = ray.origin - segCenter;
            float a01 = -Vector3.Dot(ray.direction, segDirection);
            float b0 = Vector3.Dot(diff, ray.direction);
            float s0, s1;
