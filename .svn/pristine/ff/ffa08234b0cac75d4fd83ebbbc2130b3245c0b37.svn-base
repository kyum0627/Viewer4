namespace IGX.ViewControl.Render
{
    ...
    public static class ShaderSource
    {
        ...
        public const string outlinePostFrg = Version + LightingAndPhongShading + @"
            ...
            // --- General _sceneParameters / Screen Uniforms ---
            ...
            bool detectEdge(vec3 currentFragPos, vec3 currentNormal, float currentDepth, int currentObjectID, vec4 currentAlbedoColor)
            {
                ...
                for (int i = 0; i < 4; ++i)
                {
                    ...
                    // Sample G-_instancedGeometry for neighbor's data
            ...
            void main()
            {
                ...
                // --- G-_instancedGeometry Data Sampling ---
        ...
        public const string simpleVertex_WithNormal = Version + @"
            out vec3 Normal;
            out vec3 FragPos;
        ...
        public const string simpleVertex_WithNormal1 = @"
            #version 440 core
        ...
        public const string simpleFrag_WithNormal1 = @"
            #version 440 core
